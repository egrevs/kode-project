...
public interface UserHistoryRepository extends JpaRepository<UserHistory, String> {
    ...
    @Query("""
            ...
            """)
    void closeActiveUserVersion(@Param("userId") String userId, @Param("to") LocalDateTime to);
    ...
    @Query("""
            ...
            """)
    Optional<UserHistory> findVersionAtTime(@Param("userId") String userId, @Param("now") LocalDateTime now);
}
